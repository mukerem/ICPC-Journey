...
{
x[i][j]=rand()%10;
x[i][j]=x[i][j]*pow(-1,x[i][j]);
y[i][j]=rand()%10;
y[i][j]=y[i][j]*pow(-1,y[i][j]);
}}
cout<<"What is the addition of the matrix\n";
for(int i=0;i<n;i++)
{
for(int j=0;j<m;j++)
cout<<"\t"<<x[i][j]<<setw(5);
...
cout<<"What is the adjoint of the matrix\n";
for(int i=0;i<num;i++)
{
for(int j=0;j<num;j++)
cout<<"\t"<<A[i][j]<<setw(5);
...
cin.get();
cout<<"To see the answer press ENTER\n";
cin.get();
for(int s=0;s<num;s++)
{
for(int f=0;f<num;f++)
...
cout<<"What is the determinant of\n";
for(int i=0;i<n;i++)
{
for(int j=0;j<n;j++)
cout<<"\t"<<A[i][j]<<setw(5);
...
cin.get();
if(n==1)
cout<<" the determinant is "<<A[0][0];
else if(n==2)
cout<<"the determinant is "<<A[0][0]*A[1][1]-A[0][1]*A[1][0]<<"\n\n\n";
else
{
z=pow(n,n-2);
while(z>r)
...
cout<<"What is the inverse of the matrix\n";
for(int i=0;i<num;i++)
{
for(int j=0;j<num;j++)
cout<<"\t"<<A[i][j]<<setw(5);
...
cout<<"What is the multiplication of the matrix\n";
for(int i=0;i<n;i++)
{
for(int j=0;j<m;j++)
cout<<"\t"<<x[i][j]<<setw(5);
...
cout<<"What is the row reduced echelon form of the matrix\n";
for(int i=0;i<n;i++)
{
for(int j=0;j<m;j++)
cout<<"\t"<<A[i][j]<<setw(5);
...
cout<<"What is the skew of the matrix\n";
for(int i=0;i<n;i++)
{
for(int j=0;j<m;j++)
cout<<"\t"<<x[i][j]<<setw(5);
...
cout<<"What is the solution of the equation\n";
for(int i=0;i<n;i++)
{
cout<<"Equation ("<<i+1<<")\t";
for(int j=0;j<=h;j++)
...
cout<<"What is the subtraction of the matrix\n";
for(int i=0;i<n;i++)
{
for(int j=0;j<m;j++)
cout<<"\t"<<x[i][j]<<setw(5);
...
cout<<"What is the symmetric of the matrix\n";
for(int i=0;i<n;i++)
{
for(int j=0;j<m;j++)
cout<<"\t"<<x[i][j]<<setw(5);
...
cout<<"What is the transpose of the matrix\n";
for(int i=0;i<n;i++)
{
for(int j=0;j<m;j++)
cout<<"\t"<<x[i][j]<<setw(5);
